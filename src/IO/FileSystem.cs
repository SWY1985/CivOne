...
namespace CivOne.IO
{
	public class FileSystem
	{
		...
		public static bool DataFilesExist()
		{
			...
			Console.WriteLine("- Done, all files exist");
			return true;
		}
		...
		public static bool CopyDataFiles(string folder)
		{
			...
			Console.WriteLine("- Done, all copied");
			return true;
		}
	} 
}